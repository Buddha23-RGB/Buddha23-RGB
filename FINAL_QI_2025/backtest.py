# %% [markdown]
# # Python Function for Stock Breakouts Backtester
# 
...
def final_table(symbol):
    table_path = os.path.join(
        "C:/workspaces/Congestion/hourly/signals", f"{symbol}.csv")
...
for symbol in symbols:
    ...
    table_path = os.path.join(
        "C:/workspaces/Congestion/hourly/final_tables", f"{symbol}.csv")
