...
#         ticker + "/stats/marketcap?token="
#     outDict['marketCap'] = req.get(url).text

#     # employees
#     url = "https://cloud.iexapis.com/stable/stock/" + \
#         ticker + "/stats/employees?token="
#     outDict['employees'] = req.get(url).text

#     # next dividend date
#     url = "https://cloud.iexapis.com/stable/stock/" + \
#         ticker + "/stats/nextDividendDate?token="
#     outDict['nextDivDate'] = req.get(url).text

#     # ex-dividend date
#     url = "https://cloud.iexapis.com/stable/stock/" + \
#         ticker + "/stats/exDividendDate?token="
#     outDict['exDivDate'] = req.get(url).text

#     # 1 year change
#     url = "https://cloud.iexapis.com/stable/stock/" + \
#         ticker + "/stats/year1ChangePercent?token="
#     outDict['yrChange'] = req.get(url).text

#     # dividend yield
#     url = "https://cloud.iexapis.com/stable/stock/" + \
#         ticker + "/stats/dividendYield?token="
